...
import com.fing.flowscan.binder.BinderCallback;
       ...
       View view = inflater.inflate(R.layout.fragment_traffic,container,false);
        ...
        final Handler handler = new Handler(new Handler.Callback(){
            ...
            public boolean handleMessage(Message msg) {
                ...
                if(nowInfo!=null) {
                    tv2GSendNow.setText(FUtil.formatByte(nowInfo.getmSx()));
                    tv2GReceiveNow.setText(FUtil.formatByte(nowInfo.getmRx()));
                    tvWifiSendNow.setText(FUtil.formatByte(nowInfo.getwSx()));
                    tvWifiReceiveNow.setText(FUtil.formatByte(nowInfo.getwRx()));
                }
